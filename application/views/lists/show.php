<ul id="actions">
	...
	<li> <a onclick="return confirm('Are you sure?')"
			href="<?php echo base_url(); ?>lists/delete/<?php echo $list->id; ?>">Delete List</a></li>
</ul>
...
<ul>
	...
	<li><a href="<?php echo base_url(); ?>tasks/show/<?php echo $task->task_id; ?>"><?php echo $task->task_name; ?></a>
	</li>
	<?php endforeach; ?>
</ul>
<?php else : ?>
...
<ul>
	...
	<li><a href="<?php echo base_url(); ?>tasks/show/<?php echo $task->task_id; ?>"><?php echo $task->task_name; ?></li>
	</a>
	<?php endforeach; ?>
</ul>
<?php else : ?>
